...
const SEO = ({
    ...
    return (
        <Helmet>
            ...
            <meta property="og:image" content="https://ferreyraww.vercel.app/ferreyra-board-logo.png" />
            ...
            <meta name="twitter:image" content="https://ferreyraww.vercel.app/ferreyra-board-logo.png" />
        </Helmet>
    );
}
